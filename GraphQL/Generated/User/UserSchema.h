...
struct [[nodiscard("unnecessary construction")]] SearchUser
{
	explicit SearchUser() noexcept;
	explicit SearchUser(
		bool ExactValuesArg,
		std::optional<std::string> FirstNameArg,
		std::optional<std::string> MiddleNameArg,
	...
	SearchUser(const SearchUser& other);
	SearchUser(SearchUser&& other) noexcept;
	~SearchUser();

	SearchUser& operator=(const SearchUser& other);
	SearchUser& operator=(SearchUser&& other) noexcept;
